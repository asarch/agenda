...
create table coleccion_anime (         
    id integer generated by default as identity primary key,
    nombre text,                                                              
    fecha timestamp with time zone default now()
);

create table coleccion_anime_anime (                                                                         
    coleccion integer references coleccion_anime(id) on delete cascade on update cascade,
    anime integer references anime(id) on delete cascade on update cascade,
    primary key (coleccion, anime)
);

create table pelicula_anime (
    id integer generated by default as identity primary key,
    anime integer references anime(id) on delete cascade on update cascade,
    fecha timestamp with time zone default now()
);

create table comentario_pelicula_anime (
    id integer generated by default as identity primary key,
    pelicula integer references pelicula_anime(id) on delete cascade on update cascade,
    contenido text,
    fecha timestamp with time zone default now()
);
-- -------------------------------------------------------------------
